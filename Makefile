...
full_install:
	cd weed; go install -tags "elastic gocdk sqlite ydb tarantool tikv rclone walrus"
...
test:
	cd weed; go test -tags "elastic gocdk sqlite ydb tarantool tikv rclone walrus" -v ./...
